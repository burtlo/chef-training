...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jsl-training"
  #   chef.validation_client_name = "jsl-training-validator"
  #   chef.validation_key_path = ".chef/jsl-training-validator.pem"
  # end
end
